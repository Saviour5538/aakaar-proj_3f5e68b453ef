...
const DocumentProcessingList: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          onClick={() => navigate('/document-processing/new')}
        ...
        <tbody>
          {filteredItems.map((item) => (
            <tr key={item.id}>
              ...
              <td className="border border-gray-300 px-4 py-2">{item.metadata}</td>
              ...
              <td className="border border-gray-300 px-4 py-2">
                <button
                  onClick={() => navigate(`/document-processing/${item.id}`)}
...
export default DocumentProcessingList;